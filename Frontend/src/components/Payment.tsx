...
const Payment: React.FC<Props> = ({
  ...
  return (
    <WidgetWrapper id={id} isDark={isDark} containerClass={`max-w-7xl mx-auto ${classes?.container ?? ''}`}>
      ...
      <div className="relative flex flex-wrap items-start justify-center w-full gap-8 wdt-heading-title-wrapper wdt-heading-align-center wdt-heading-deco-wrapper motion-safe:opacity-0 motion-safe:intersect:animate-fade">
        {items &&
