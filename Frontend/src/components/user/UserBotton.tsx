    ...
    <div>
      {
        ...
        <button
          className="flex items-center pl-4 hover:text-link whitespace-nowrap"
          type="button"
          ...
          <ul
          className="font-medium drop-shadow-xl dropdown-menu md:absolute md:backdrop-blur-md md:bg-white/90 md:hidden md:min-w-[80px] md:pl-0 pl-4 rounded"
          >
            <li>
              <LogoutButton/>
            </li>
