...
const Bloomberg: React.FC<LogoProps> = ({ size = '960', color = 'currentColor' }) => (
  <svg
    ...
    enableBackground="new 115 -9.6 257.8 47.6"
    width={size}
    height={size}
    style={{ color }}  
  >
    <g>
      ...
      ></path>
      <path fill="currentColor" d="M149.1-9.6h9.9v38.5h-9.9V-9.6z"></path>
      <path
        fill="currentColor"
